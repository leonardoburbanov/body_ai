...
export class MongoDBRecipeRepository implements RecipeRepository {
  ...
  async create(recipeData: CreateRecipeDTO): Promise<Recipe> {
    ...
    const recipe: Omit<Recipe, "id"> = {
      ...
      carbohidratos_diarios_objetivo: recipeData.carbohidratos_diarios_objetivo,
      grasa_diaria_objetivo: recipeData.grasa_diaria_objetivo,
  ...
  private mapToRecipe(doc: any): Recipe {
    return {
      ...
      carbohidratos_diarios_objetivo: doc.carbohidratos_diarios_objetivo,
      grasa_diaria_objetivo: doc.grasa_diaria_objetivo,
